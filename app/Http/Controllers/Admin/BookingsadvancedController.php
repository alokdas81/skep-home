...
class BookingsadvancedController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        bookings.booking_type = 'advanced'      
        ORDER BY created_at DESC");
        return view('admin.bookingsadvanced.index', compact('bookings','request'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.bookingsadvanced.create',compact('users', 'cleaner', 'extra_services', 'all_services', 'myspace_details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($requestData['extra_services'])){
            ...
            $create_array = ['booking_date' => $booking_date, 'service_start_time' => $requestData['service_start_time'], 'service_end_time' => $requestData['service_end_time'], 'booking_price' => $this->amountToFloat($requestData['booking_price']), 'user_id' => $requestData['user_id'], 'service_provider_id' => $requestData['service_provider_id'], 'booking_services' => $extra_services, 'space_id' => $requestData['space_id'], 'special_instructions' => $requestData['special_instructions'], 'booking_type' => 'advanced'];
        } else{
            $create_array = ['booking_date' => $booking_date, 'service_start_time' => $requestData['service_start_time'], 'service_end_time' => $requestData['service_end_time'], 'booking_price' => $this->amountToFloat($requestData['booking_price']), 'user_id' => $requestData['user_id'], 'service_provider_id' => $requestData['service_provider_id'], 'space_id' => $requestData['space_id'], 'special_instructions' => $requestData['special_instructions'], 'booking_type' => 'advanced'];
        }
        Bookings::create($create_array);
        return redirect('admin/bookingsadvanced')->with('flash_message', 'Advanced Booking created!');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.bookingsadvanced.show', compact('bookings'));
    }
    ...
    public function edit($id)
    {
        ...
        $myspace_details = Myspace::all();
        return view('admin.bookingsadvanced.edit', compact('booking', 'users', 'cleaner', 'extra_services', 'all_services', 'values', 'myspace_details'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/bookingsadvanced')->with('flash_message', 'Advanced Booking updated!');
    }
    ...
    {
        Bookings::destroy($id);
        return redirect('admin/bookingsadvanced')->with('flash_message', 'Advanced Booking deleted!');
    }
}
